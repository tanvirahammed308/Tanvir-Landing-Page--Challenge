...
const Banner = () => {
  return (
    <div className="flex justify-center items-center  w-full  md:[400px] md:h-[500px] bg-[#EAEAEA] relative md:mb-40 mb-56 ">
      <Carousel
        showThumbs={false}
        showStatus={false}
        infiniteLoop
        ...
        autoPlay
        interval={10000}
        className=" p-5 w-[450px]  h-[450px] bg   mt-5"
      >
       
        
        <div className="">
          <img src="/b1.png" alt="Slide 1" className="mt-8" />
        </div>
        <div className="">
          <img src="/b1.png" alt="Slide 1" className="mt-8" />
        </div>
      ...
      <div className="w-[100px] md:w-[250px] absolute top-28 right-[350px] md:right-[830px] ">
